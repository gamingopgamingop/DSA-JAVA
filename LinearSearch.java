    ...
    public static void demonstrateAllImports() {
        try {
            ...
            PrintStream printStream = new PrintStream(new BufferedOutputStream(
                new FileOutputStream("linear_search_demo.txt")), true);
            printStream.println("Linear Search Demo Output");
            printStream.close();
            
            // Character encoding
            String encodedText = "Linear Search Demo";
            ...
            // Stream Tokenizer
            String sampleText = "Linear 123 Search 456 Demo";
            ...
            printer.accept("Hello from Linear Search!");
            ...
            System.out.println("All imports demonstrated successfully in Linear Search!");
