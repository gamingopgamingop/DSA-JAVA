...
graph TD
    %% Main Domains
    MATH[Mathematics] --> DSA[Data Structures & Algorithms]
    MATH --> AI[Artificial Intelligence]
    CS[Computer Science] --> DSA
    CS --> DEV[Software Development]
    DSA --> AI
    ...
    %% Connections
    MATH --> GRAPH_TH[Graph Theory]
    GRAPH_TH --> NET
    GRAPH_TH --> DSA_GRAPH[Graph Algorithms]
    DSA --> SYS_DESIGN[System Design]
    DEV --> SYS_DESIGN
    
    %% Emerging Tech
    MATH --> QUANTUM[Quantum Computing]
